...
function showData(DataWeather){
 ...
 var finalTempCelsius = parseInt(main.feels_like-273.15);
 var finalTempFarenheit = parseInt((main.feels_like-273.15) * (9 / 5) + 32);
...
showFinal.innerHTML=`
<div class="city-name">
                <h3 class="text-white"> ${DataWeather.name}, ${countryName}</h3>
            ...
            <div class="weather-data">
                <h3 class="text-white">${finalTempCelsius}<sup>&#176</sup>C / ${finalTempFarenheit}<sup>&#176</sup>F</h3>
            </div>
